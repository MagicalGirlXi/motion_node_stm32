 ...
 */
#define MOTION_DRIVER_TARGET_MSP430   //定义————————————————————————————————————————————————————————
#if defined MOTION_DRIVER_TARGET_MSP430
//#include "msp430.h"
//#include "msp430_clock.h"
#include "stm32f3xx_hal.h"
#include "main.h"
#define delay_ms    rt_thread_mdelay//msp430_delay_ms
#define get_ms      get_ms//msp430_get_clock_ms
#define log_i       printf// do {} while (0)  (...)   
#define log_e       printf// do {} while (0)  (...)   
...
//    __no_operation();  //_________________________________________________________________
